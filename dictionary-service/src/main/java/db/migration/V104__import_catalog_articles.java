...
public class V104__import_catalog_articles extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        importArticles(context, "catalog/planets.catalog", "bounty.planets", 16);
        importArticles(context, "catalog/sectors.catalog", "bounty.sectors", 10);
        importArticles(context, "catalog/factions.catalog", "bounty.factions", 10);
    }
