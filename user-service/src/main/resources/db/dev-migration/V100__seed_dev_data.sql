...
/*
Orders, applications and offers moved to orders-service.
Keep this old block disabled so user-service dev migrations do not write data owned by another service.
